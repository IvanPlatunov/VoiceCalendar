...
class CommandParser: 
    ...
    TRIGGER_WORDS = [
        "поставь", "запиши", "добавь", "напомни", "создай",
        "поставить", "записать", "добавить", "напомнить", "создать",
        "внеси", "внести", "запланируй", "запланировать",
        ]
    
    TASK_KEYWORDS = [
        "задачу", "задание", "напоминание", "встречу", "дело",
        "событие", "мероприятие", "звонок", "совещание"
        ]
    ...
    PRIORITY_KEYWORDS: Dict[str, int] = {
        "срочно": 2, "срочный": 2, "срочную": 2,
        "важно": 2, "важный": 2, "важную": 2, "важное": 2,
        "высокий": 2, "высоким": 2, "высокую": 2,
        "средний": 1, "средним": 1, "среднюю": 1,
        "обычный": 0, "обычным": 0, "обычную": 0,
        "низкий": 0, "низким": 0, "низкую": 0,
    }
