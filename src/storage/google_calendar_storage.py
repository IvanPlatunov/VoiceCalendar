"""
Хранилище задач в Google Calendar с цветовыми метками приоритетов.
"""
...
class GoogleCalendarStorage(BaseCalendarStorage):
    ...
    # =========================================================================
    # CRUD (используют _fetch_events и методы преобразования)
    # =========================================================================
    ...
    def search_tasks(self, query: str) -> List[Task]:
        return [
            self._event_to_task(e)
            for e in self._fetch_events(query=query)
        ]
    
    def get_task_count(self) -> int:
        return len(self._fetch_events(limit=1))  # Быстрая оценка
        # Для точного подсчёта: return len(self.get_all_tasks())
